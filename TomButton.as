package 
{
	...
	public class TomButton extends MovieClip{
		...
		public var tomSoundArray:Array = new Array();	// array variable that will hold the sound of the button
														// when the button is pressed, alpha is less than 1 and 
														//then the sound will be pushed into the array



		[Embed(source = "sounds/Tom-Base.mp3")]	//getting the path of the sample and embeding it in the app
