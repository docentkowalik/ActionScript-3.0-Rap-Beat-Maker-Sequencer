package  {
	...
	public class SnareButton extends MovieClip {
		...
		public var snareSoundArray:Array = new Array();	// array variable that will hold the sound of the button
														// when the button is pressed, alpha is less than 1 and 
														//then the sound will be pushed into the array

		
		[Embed(source = "sounds/Snare.mp3")]	//getting the path of the sample and embeding it in the app
		
		public var snareSoundClass:Class;
		
		public var snareSound:Sound = new snareSoundClass() as Sound;
		
		public function SnareButton()
		{
			// constructor code
		...
		public function checkButtonState(event:MouseEvent)
		{
			...
			{
				this.alpha = 0.5;	
				snareSoundArray.push(snareSound);			
				trace(snareSoundArray);						
				//snareSound.play();						
