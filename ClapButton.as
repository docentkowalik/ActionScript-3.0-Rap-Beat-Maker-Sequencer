package  {
	...
	public class ClapButton extends MovieClip {
		...
		public var clapSoundArray:Array = new Array();	// array variable that will hold the sound of the button
														// when the button is pressed, alpha is less than 1 and 
														//then the sound will be pushed into the array


		
		[Embed(source = "sounds/Clap.mp3")]	//getting the path of the sample and embeding it in the app
		
		public var clapSoundClass:Class;
		
		public var clapSound:Sound = new clapSoundClass() as Sound;
		
		public function ClapButton()
		{
			// constructor code
		...
		public function checkButtonState(event:MouseEvent)
		{
			...
			{
				this.alpha = 0.5;
				clapSoundArray.push(clapSound);
				trace(clapSoundArray);
				//snareSound.play();
