package  {
	...
	public class CloseHButton extends MovieClip {
		...
		public var closeHSoundArray:Array = new Array();	// array variable that will hold the sound of the button
															// when the button is pressed, alpha is less than 1 and 
															//then the sound will be pushed into the array


		
		[Embed(source = "sounds/closeHat.mp3")]	//getting the path of the sample and embeding it in the app
		
		public var closeHSoundClass:Class;
		
		public var closeHSound:Sound = new closeHSoundClass() as Sound;
		
		public function CloseHButton()
		{
			// constructor code
		...
		public function checkButtonState(event:MouseEvent)
		{
			...
			{
				this.alpha = 0.5;
				closeHSoundArray.push(closeHSound);
				trace(closeHSoundArray);
				//snareSound.play();
